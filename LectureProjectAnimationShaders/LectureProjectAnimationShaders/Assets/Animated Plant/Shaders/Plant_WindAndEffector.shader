Shader "Custom/Plant_WindAndEffector"
{
    Properties
    {
        ...
        // this is the position of the effector in world space we will use the w component to store the radius
        _EffectorSource ("Effector Source (xyz) + Radius (w)", Vector) = (0, 0, 0, 0)
        // this is the strength of the effector, how much it will bend the mesh
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 ApplyWind(float heightFactor)
            {
                ...
                float windStrengthOverTime = (windPhase + 1.0) * 0.5;
